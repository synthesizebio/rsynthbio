...
See the [Baseline Models](/rsynthbio/models/baseline) vignette for detailed usage.
...
See the [Reference Conditioning](/rsynthbio/models/reference-conditioning) vignette for detailed usage.
...
See the [Metadata Prediction](/rsynthbio/models/metadata-prediction) vignette for detailed usage.
...
Each model accepts a specific set of metadata fields with defined vocabularies (valid ontology IDs, cell lines, tissues, etc.). You can browse and download these vocabularies at [app.synthesize.bio/docs/vocab](https://app.synthesize.bio/docs/vocab).

See the [Available Metadata](/rsynthbio/available-metadata) vignette for more details.
