...
result$metadata$cell_type_ontology_id
result$metadata$tissue_ontology_id
result$metadata$disease_ontology_id
```
...
provided_labels <- c("liver", "liver", "brain", "brain")
predicted_labels <- result$metadata$tissue_ontology_id
...
tapply(result$latents$technical[, 1], batch_labels, mean)
```
