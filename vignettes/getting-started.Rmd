...
- ``cell_type_ontology_id``: Requires a [CL ID](https://www.ebi.ac.uk/ols/ontologies/cl).
- ``disease_ontology_id``: Requires a [MONDO ID](https://www.ebi.ac.uk/ols/ontologies/mondo).
...
- ``tissue_ontology_id``: Requires a [UBERON ID](https://www.ebi.ac.uk/ols/ontologies/uberon).
